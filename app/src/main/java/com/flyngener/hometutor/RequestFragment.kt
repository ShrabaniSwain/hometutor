...
import com.flyngener.hometutor.databinding.FragmentRequestBinding
        ...
        call.enqueue(object : Callback<AssignBookingResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    val inflater =
                        LayoutInflater.from(requireContext()).inflate(R.layout.assign_dialog_box, null)
                    ...
                    val tvNoData = inflater.findViewById<TextView>(R.id.tvNoData)
                    val rejectButton = inflater.findViewById<TextView>(R.id.rejectButton)
                    ...
                    rejectButton.setOnClickListener {
                        ...
                        if (Constant.BUDGET.isEmpty()) {
                            ...
                            payAfterAssign = PayAfterAssign(Constant.BOOKING_ID, amount, "", Constant.UNIT_TYPE, Constant.INSERT_ID)
