...
import com.flyngener.tutorhub.databinding.ActivityQualificationAddressBinding
...
class QualificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (sharedPrefHelper.isLoggedIn()) {
            ...
            if (etQualification.isEmpty() || etExperience.isEmpty() || etDob.isEmpty() || etAge.isEmpty() || etGender.isEmpty() || etAbout.isEmpty()
            ) {
