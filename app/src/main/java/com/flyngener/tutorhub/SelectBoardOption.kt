...
import com.flyngener.tutorhub.databinding.ActivitySelectBoardOptionBinding
...
class SelectBoardOption : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            if (Constant.selectUnitList.isEmpty() || Constant.selectUnitList.size != 3){
                Toast.makeText(this, "Please select your details", Toast.LENGTH_SHORT).show()
            }
            else {
