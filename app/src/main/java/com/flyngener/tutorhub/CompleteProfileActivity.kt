...
import com.flyngener.tutorhub.databinding.ActivityCompleteProfileBinding
...
//            if (unitId1.isNotEmpty() && unitName1.isNotEmpty()) {
//                val unit1Detail = UnitDetail(unit_id = unitId1, unit_name = unitName1, sub_units = selectedUnit1List)
//                unit1DetailJson = gson.toJson(Constant.unitDetailsList)
//            }
//
//            if (unitId2.isNotEmpty() && unitName2.isNotEmpty()) {
//                val unit2Detail = UnitDetail(unit_id = unitId2, unit_name = unitName2, sub_units = selectedUnit2List)
//                unit2DetailJson = gson.toJson(unit2Detail)
//            }
        ...
        call.enqueue(object : Callback<SelectUnitResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    val selectBoardAdapter = CompleteProfileUnitAdapter(selectUnit, applicationContext)
    ...
    private fun teacherAddStudent(teacher_id: String, booking_id: String, guardian_id: String, student_name: String, gender: String, dob: String, age: String, address: String, appointment_location: String,
                                  fees_amount: String, fees_c_date: String, student_image: Uri?, start_date: String, unitIds: String
    ) {
        showProgressBar()
