...
import com.flyngener.tutorhub.databinding.ActivityGuardianTermsBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class GuardianTermsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGuardianTermsBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGuardianTermsBinding.inflate(layoutInflater)
    ...
    private fun getTermsList() {
        showProgressBar()
        val call = RetrofitClient.api.getTermsGuardianList()
